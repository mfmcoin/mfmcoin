MFMCoin Core version 0.14.2 is now available from:
...
MFMCoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in MFMCoin Core 0.10.4) it has been disabled by default.
...
MFMCoin Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
When MFMCoin Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was disabled and deprecated in MFMCoin Core 0.10.4 and removed in 0.13.2. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of MFMCoin Core. This was added in conjunction with
...
here, originally written for Bitcoin but can also be used for MFMCoin:
