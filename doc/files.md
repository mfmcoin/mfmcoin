...
* MFMCoin.conf: contains configuration settings for mfmcoind or mfmcoin-qt
* mfmcoind.pid: stores the process id of mfmcoind while running
...
* debug.log: contains debug information and general logging generated by mfmcoind or mfmcoin-qt
