...
"""Verify that starting MFMCoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start MFMCoin with -h for help text")
        ...
        self.log.info("Start MFMCoin with -version for version information")
