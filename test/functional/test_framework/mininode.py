...
"""mFm coin P2P network half-a-node.
...
class P2PConnection(asyncore.dispatcher):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.info('Connecting to mFm coin Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a mFm coin node.
