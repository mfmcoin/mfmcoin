...
public:
    CMainParams() {
        ...
        pchMessageStart[1] = 53;
        pchMessageStart[2] = 211;
        pchMessageStart[3] = 55;
        nDefaultPort = 6593;
...
public:
    CTestNetParams() {
        ...
        pchMessageStart[0] = 241;
        pchMessageStart[1] = 137;
        pchMessageStart[2] = 85;
        pchMessageStart[3] = 154;
        nDefaultPort = 16595;
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,145);
