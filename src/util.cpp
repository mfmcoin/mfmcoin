...
const char * const BITCOIN_CONF_FILENAME = "mfmcoin.conf";
const char * const BITCOIN_PID_FILENAME = "mfmcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "mFm coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/mFm coin";
#else
    // Unix
    return pathRet / ".mfmcoin";
#endif
#endif
}
