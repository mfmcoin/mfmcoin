...
const QString BITCOIN_IPC_PREFIX("mfmcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/mfmcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mfmcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mfmcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start mfmcoin: click-to-pay handler"));
        }
        else {
